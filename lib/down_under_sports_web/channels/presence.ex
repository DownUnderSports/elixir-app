defmodule DownUnderSportsWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule DownUnderSports.MyChannel do
  ...
  """
  use Phoenix.Presence, otp_app: :down_under_sports,
                        pubsub_server: DownUnderSports.PubSub
end
